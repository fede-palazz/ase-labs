...
CHECK_V1:
        ; Check if v1 was flagged as NOT palindrome
        beqz R5,CHECK_V2
        ; Load values from v1
        lb R3,v1(R1)
        lb R4,v1(R2)
...
NOT1:
        ; Set v1 as not palindrome
        daddi R5,R0,0           ; R5 = 0

CHECK_V2:
        ; Check if v2 was flagged as NOT palindrome
        beqz R6,CHECK_V3
        ; Load values from v2
        lb R3,v2(R1)
        lb R4,v2(R2)
...
NOT2:
        ; Set v2 as not palindrome
        daddi R6,R0,0           ; R6 = 0

CHECK_V3:
        ; Check if v3 was flagged as NOT palindrome
        beqz R7,CHECK_LOOP
        ; Load values from v3
        lb R3,v3(R1)
        lb R4,v3(R2)
